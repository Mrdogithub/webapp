        ...
        <div class="messageInfoWrapper">
            ...
            <div class="largeBtnWrapper">
                <div class="btn-wrapper ">
                    <Button style="width:266px;height:55px" type="primary" class="largeBtn" @click = "cancelConfirm" >Cancel</Button>
                </div>
                <div class="modifyOrder">
                    <Button type="primary" style="width:266px;height:55px;border-color:#fff" class="largeBtn" @click="backConfirm">Back</Button>
                </div>
            </div>
        </div>
    </div>
