...
<div>
	...
	<requestconfirmation ref = "requestconfirmationHook"></requestconfirmation>
</div>
...
export default {
	...
	data () {
		return {
			...
			orderInformation: {contactName: '', mobileNumber: ''}
		}
    },
    components: {
		'bar': bar,
	...
	created () {
		let _baseDataObj = this.$route.params
		console.log(1, _baseDataObj)
		this.contactName = _baseDataObj.customer_name
		this.mobileNumber = _baseDataObj.customer_phoneNumber
		this.currentMileage = _baseDataObj.customer_mileage
		this.serviceConsultant = _baseDataObj.customer_consultant
		this.note = _baseDataObj.customer_note
		this.appointmentTime = _baseDataObj.chooseDate + '/' + _baseDataObj.chooseTime
		this.vehicleServicing = _baseDataObj.customer_name
		this.dealerInformation = {name: _baseDataObj.name, address: _baseDataObj.address, phone: _baseDataObj.phone}
		this.orderInformation = {contactName: _baseDataObj.customer_name, mobileNumber: _baseDataObj.customer_phoneNumber}
		this.serviceType = _baseDataObj.customer_serviceType
	},
	methods: {
		showServiceDetail () {
			console.log('ss')
		...
		submitFn () {
			...
			let showAjaxStatus = false
			this.previewOrderSummaryStatus = false
			this.$refs.requestconfirmationHook.showRequestConfirmationStatus(showPostOverLay, showAjaxStatus, this.$route.params)
		}
	}
}
</script>
